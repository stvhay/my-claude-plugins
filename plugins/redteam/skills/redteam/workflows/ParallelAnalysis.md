...
### PHASE 4: STEELMAN
Produce an 8-point explanation (12-16 words each) representing the STRONGEST possible version of the original argument.

### PHASE 5: COUNTER-ARGUMENT
Produce an 8-point explanation (12-16 words each) representing the strongest possible rebuttal.

## PHASE 1: Decomposition Protocol

### Step 1.0: First Principles Deconstruction

Before traditional decomposition, deconstruct the argument to surface:
...
Decompose the argument into exactly 24 discrete claims:
...
|-------|-------------|--------------|
| EN-1 | **The Skeptical Systems Thinker** | "Where does this break at scale?" |
| EN-2 | **The Evidence Demander** | "Show me the numbers that prove this." |
| EN-3 | **The Edge Case Hunter** | "What happens when X is not true?" |
| EN-4 | **The Historical Pattern Matcher** | "We tried this in 2008 and here's what happened." |
| EN-5 | **The Complexity Realist** | "This is harder than it sounds because..." |
| EN-6 | **The Dependency Tracer** | "This assumes X, which assumes Y, which is false." |
| EN-7 | **The Failure Mode Analyst** | "Here are 5 ways this fails catastrophically." |
| EN-8 | **The Technical Debt Accountant** | "The real price of this approach is..." |
...
| Agent | Personality | Attack Angle |
|-------|-------------|--------------|
| AR-1 | **The Big Picture Thinker** | "This ignores how it fits into the larger system." |
| AR-2 | **The Trade-off Illuminator** | "You gain X but lose Y, and Y matters more." |
| AR-3 | **The Abstraction Questioner** | "These aren't the same category of problem." |
| AR-4 | **The Incentive Mapper** | "Who benefits from this being true?" |
| AR-5 | **The Second-Order Effects Tracker** | "This causes A, which causes B, which destroys C." |
| AR-6 | **The Integration Pessimist** | "This doesn't compose with existing reality." |
| AR-7 | **The Scalability Skeptic** | "This can't scale because..." |
| AR-8 | **The Reversibility Analyst** | "Once you do this, you can't go back." |
...
| Agent | Personality | Attack Angle |
|-------|-------------|--------------|
| PT-1 | **The Red Team Lead** | "Here's how I'd exploit this logic." |
| PT-2 | **The Assumption Breaker** | "This depends on X, and X is false." |
| PT-3 | **The Game Theorist** | "A smart opponent would simply..." |
| PT-4 | **The Social Engineer** | "People will route around this because..." |
| PT-5 | **The Precedent Finder** | "This is just [past example] in a new dress." |
| PT-6 | **The Defense Evaluator** | "This defense fails because attackers can..." |
| PT-7 | **The Threat Modeler** | "You've left this entire surface undefended." |
| PT-8 | **The Asymmetry Spotter** | "Attackers have unlimited time; defenders don't." |
...
| Agent | Personality | Attack Angle |
|-------|-------------|--------------|
| IN-1 | **The Naive Questioner** | "But why do we assume X in the first place?" |
| IN-2 | **The Analogy Finder** | "This is just like [other field] where it failed." |
| IN-3 | **The Contrarian** | "What if the exact opposite is true?" |
| IN-4 | **The Common Sense Checker** | "This violates basic intuition because..." |
| IN-5 | **The Zeitgeist Reader** | "In practice, nobody actually does this because..." |
| IN-6 | **The Simplicity Advocate** | "The simpler explanation is..." |
| IN-7 | **The Edge Lord** | "If this is true, then [absurd consequence] must also be true." |
| IN-8 | **The Devil's Intern** | "The uncomfortable truth nobody wants to say is..." |
...
Before finalizing the counter-argument, classify every constraint as:
...
### Output Format: 8-Point Explanation
...
```
[ ] PHASE 1: Decomposition
  [ ] First-principles deconstruction of the argument
...
- Phase 4-5: 2-3 minutes (final output)
