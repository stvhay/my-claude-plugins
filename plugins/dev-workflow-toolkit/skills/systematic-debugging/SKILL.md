...
**Red flags — if you catch yourself thinking any of these, STOP and return to Phase 1:**
...
4. **Gather Evidence in Multi-Component Systems**
   ...
   For each component boundary, log data entering and exiting to identify the failing layer.
