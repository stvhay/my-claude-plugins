...
**Worktree auto-detection:** Run `git rev-parse --show-toplevel`. If the path contains `.claude/worktrees/`, confirm you're operating in the correct worktree for the plan's issue. Cross-reference the `.issue` file if present.
